#############################################################################
# Makefile for building: TetrisTDD
# Generated by qmake (3.1) (Qt 5.8.0)
# Project:  TetrisTDD.pro
# Template: app
# Command: /home/nico/Qt/5.8/gcc_64/bin/qmake -o Makefile TetrisTDD.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../../Qt/5.8/gcc_64/include -I../../Qt/5.8/gcc_64/include/QtGui -I../../Qt/5.8/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I../../Qt/5.8/gcc_64/mkspecs/linux-g++
QMAKE         = /home/nico/Qt/5.8/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = TetrisTDD1.0.0
DISTDIR = /home/nico/workspace/TetrisSource/.tmp/TetrisTDD1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/nico/Qt/5.8/gcc_64/lib
LIBS          = $(SUBLIBS) -L/home/nico/Qt/5.8/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = README.md \
		...
		Block.h \
		Piece.h \
		Tetromino.h TetrisBehaviour.cpp \
		Board.cpp \
		Piece.cpp \
		Tetromino.cpp
...
Makefile: TetrisTDD.pro ../../Qt/5.8/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.8/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.8/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.8/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.8/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.8/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile TetrisTDD.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
../../Qt/5.8/gcc_64/mkspecs/features/spec_pre.prf:
../../Qt/5.8/gcc_64/mkspecs/common/unix.conf:
../../Qt/5.8/gcc_64/mkspecs/common/linux.conf:
../../Qt/5.8/gcc_64/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Board.h Block.h Piece.h Tetromino.h $(DISTDIR)/
	$(COPY_FILE) --parents TetrisBehaviour.cpp Board.cpp Piece.cpp Tetromino.cpp $(DISTDIR)/
